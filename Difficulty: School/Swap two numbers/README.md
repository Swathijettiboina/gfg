<h2><a href="https://www.geeksforgeeks.org/problems/swap-two-numbers3844/1?page=1&company=Amazon,Microsoft,Flipkart,Google,Samsung,Zoho,Paytm,Yahoo,Wipro,Twitter,Myntra,Accenture,Infosys,Cognizant,Dell,Intel&sortBy=difficulty">Swap two numbers</a></h2><h3>Difficulty Level : Difficulty: School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 20px;">Swap given two numbers and print them. (Try to do it without a temporary variable.) and return it.</span></p>
